# Step 5: Media Selector Component
...
This step implements the `MediaSelector` component, which opens a file browser modal to choose images uploaded to Cloudflare R2.

## 1. Create Media Selector Component

### File: [MediaSelector.tsx](file:///d:/projects/CS-Dashboard/cs-dashboard/src/components/admin/MediaSelector.tsx)
...
- [ ] Component file created at [MediaSelector.tsx](file:///d:/projects/CS-Dashboard/cs-dashboard/src/components/admin/MediaSelector.tsx).
- [ ] List function from server actions imported correctly.
- [ ] Verification that it opens the modal window and displays folder items correctly.
